...
更多详情见：https://blog.csdn.net/jin13277480598/article/details/53842378

## 4、sockaddr_in和sockaddr_un结构体
...
## 5、linux中socket编程出现 connect: No route to host
...
## 9、struct sockaddr和struct sockaddr_in
这两个结构体用来处理网络通信的地址。
