...
## 4、银行家算法
https://blog.csdn.net/Carmelo_7/article/details/121253336
...
### 4-4、demo
见：D:\Github\Storage\c++\standard_library\lock\banker.cpp

大概懂这个算法的意图，就是当有进程满足需求条件时就进行工作，然后把自己分配的资源释放，更新可用资源向量，然后再扫描进程队列，如果有满足需求条件就进行工作，如果扫描全部没有满足条件的就是不安全状态，需要全部进程完成工作就是安全状态。
