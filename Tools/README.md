...
|  进程监视器  |                apimonitor                 |                                           |
|   查看依赖   |                  procexp                  |                                           |
| 文件搜索神器 |                everithing                 | https://www.voidtools.com/zh-cn/          |
|   下载工具   |                   迅雷                    |                                           |
| 在线视频播放 |                 ZY Player                 |                                           |
|   卸载工具1  |                   geek                    | https://geekuninstaller.com/              |
|   卸载工具2  |           HiBit Uninstaller               | https://www.hibitsoft.ir/                 |
|   本地搜索   |                everything                 |                                           |
|   解压工具   |                    7z                     |                                           |
...
|  看书软件    |            Koodo Reader                   | https://www.koodoreader.com/zh            |
...
### 16-2、并不是万能的，确实部分文件还是搜索不到的
如C:\Windows\explorer.exe文件就搜索不到，已在windows10和windows7上面做实验。
