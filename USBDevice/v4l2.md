# V4L2编程
一开始还以为是v412。。。
学习了两遍，查询了大量资料，最简单易懂代码最清晰的来自https://mp.weixin.qq.com/s/bbh9uY5q0CrqXDCc8rzLQA
...
已搞清楚，通过https://mp.weixin.qq.com/s/bbh9uY5q0CrqXDCc8rzLQA，以及D:\Github\Storage\udev\v4l2\验证VIDIOC_QBUF和VIDIOC_DQBUF\v4l2_tool.cpp，都可以看出，是先进行入队列VIDIOC_QBUF，然后才能出队列VIDIOC_DQBUF，才会有数据，使用完后需要放回去，即如队列VIDIOC_QBUF。
