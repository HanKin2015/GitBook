...
## 14、部落冲突
### 小博控制室第 1 个条件：改装 3 个建筑
就是**主世界（家乡）改装：1 座加农炮、1 座箭塔、1 座迫击炮**，三样各改 1 个，不能多改同类，全部改完才算完成这个任务。

改装（Gear‑up）：夜世界的建筑大师跑到主世界，把普通防御改成**双模式防御**，改装完可以切换攻击模式九游

建筑主世界等级夜世界（建筑大师基地）对应建筑等级加农炮7 级双管加农炮 4 级箭塔10 级箭塔 6 级迫击炮8 级多管迫击炮 8 级

1. 改装的时候，**夜世界的建筑大师工人必须空闲**，他要坐船来主世界干活；改装期间夜世界没人干活九游。
2. 每一种防御**只能改装 1 个**，比如你家里 8 门加农炮，只需要改其中 1 门即可。
3. 改装消耗主世界金币，改装时间很长（迫击炮要 14 天），可以用书 / 锤子直接秒掉。
4. 不是升级！是点建筑弹出的【改装】按钮，升级按钮不算。

### 📌小博控制室全部 4 个解锁六农条件完整清单

1. 主世界改装 3 个建筑（加农炮、箭塔、迫击炮各 1 座）
2. 夜世界**任意一个兵种升到 18 级**
3. 夜世界**任意防御升到 9 级（城墙不算）**
4. 夜世界双英雄（战争机器 + 战斗直升机）等级总和≥45 级

> 
> 小博控制室要先解锁：**夜世界大本营 9 级**才能造这个建筑Supercell。

### 💡速通小技巧

夜世界多管迫击炮升到 8 级满足改装，**直接再升 1 级到 9 级**，一次性同时完成【改装迫击炮】+【任意防御 9 级】两个条件，节省大量资源时间。
