...
## 9、体脂率
体脂率是脂肪率，也是判断一个人胖还是瘦的标准之一，可以有效反映人体内的脂肪量。

1、体重指数(BMI)：BMI=体重(kg)/身高(m^2)，可根据公式计算不同体重处于何种状态。根据我国BMI标准，正常为18.5-23.9kg/m^2，体重过低为＜18.5kg/m^2，超重为24-27.9kg/m^2，肥胖为≥28kg/m^2；

2、体脂率：体脂率的标准在不同国家各有不同，男性通常为15%-20%，女性通常为20%-25%。如为运动员或经常锻炼的人群，体脂率可能相对较低。因体脂率计算公式较为复杂，可通过体脂秤等方式辅助进行计算。关注体脂率有助于避免肥胖的发生，可更好地控制机体内脂肪量等。

对于体脂率的计算，可以通过下面两个公式:
1、计算体重指数(BMI)：BMI＝体重(单位：Kg)÷身高的平方（单位：米）。
2、计算体脂率：1.2×BMI＋0.23×年龄－5.4-10.8×性别，对于第2个公式中的性别，男性为1，女性为0，按照这个数值计算。

我设置的身高170cm，体重69.95kg，算出来的BMI就是24.2
体脂率：23.8%x69.95=16.65kg
1.2x24.2+0.23x29-5.4-10.8x1=
算不出来跟小米体脂秤一样的结果，它可能是通过生物电阻抗法计算的。（体脂称实际是向人体内通电流，然后通过算法粗略估计体脂率，所得结果与你设定的身高和年龄有关）

体脂率是指人体中脂肪组织所占的百分比。计算体脂率的方法有多种，以下是常用的两种方法：
皮褶厚度法：这种方法通过测量身体不同部位的皮褶厚度来估算体脂率。通常会测量胸部、腹部、大腿等部位的皮褶厚度，然后使用公式计算体脂率。这种方法需要专业人员进行测量和计算。

生物电阻抗法：这种方法使用生物电阻抗仪来测量人体对电流的阻抗，从而估算体脂率。生物电阻抗仪通过电流在人体组织中的传导速度和阻抗来计算体脂率。这种方法通常需要使用专业的生物电阻抗仪器。

无论使用哪种方法，都需要注意以下几点：
测量时应保持身体放松，避免剧烈运动或进食。
测量时应遵循专业人员的指导，确保准确性和安全性。
不同的测量方法可能会有一定的误差，因此最好在同一种方法下进行多次测量，取平均值作为参考。