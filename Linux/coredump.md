...
## 2、coredump文件的存储位置
debian系统位置：核心文件的默认路径实际上是/var/lib/systemd/coredump
...
进阶：
```
[root@ubuntu0006:~] #cat /proc/sys/kernel/core_pattern
/tmp/coredump/123
[root@ubuntu0006:~] #cat /etc/sysctl.conf
kernel.core_pattern=/tmp/coredump/123
# modify socket buffer size
net.core.rmem_default = 33554432
net.core.rmem_max = 33554432
[root@ubuntu0006:~] #echo "/tmp/coredump/core" > /proc/sys/kernel/core_pattern
[root@ubuntu0006:~] #cat /proc/sys/kernel/core_pattern
/tmp/coredump/core
[root@ubuntu0006:~] #cat /etc/sysctl.conf
kernel.core_pattern=/tmp/coredump/123
...
kernel.panic = -1
kernel.sysrq = 0
kernel.core_pattern= | /usr/local/bin/gzip_core_dump.sh /other/core/%e.core.%s.%p
[root@ubuntu0006:~] #cat /etc/security/limits.conf
